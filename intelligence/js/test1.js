window.Test1 = (function () {
    ...
    test1 = {
        ...
        /**
         * Just removes startbutton and creates a div that holds the score
         */
        ...
        question1: function() {
            ...
            /**
             * Each time a question starts
             * the counter resets so it´s only possible to choose one answer.
             */
            var counterChoice = 0;
            ...
            question1.innerHTML = "Vad är en mitokondrie?";
            ...
            alternative3.innerHTML = "En organell som återfinns i t.ex. mänskliga celler";
            content.appendChild(alternative3);

            /**
             * Adds eventlistener to a button with one of the alternative answers
             */
            alternative1.addEventListener("click", function () {
                result1.innerHTML = "Fel :(";
                alternative1.classList.toggle("red")
                alternative2.classList.toggle("red")
                alternative3.classList.toggle("green")
                if (counterChoice < 1) {
                    test1score = 0;
            ...
            nextButton.addEventListener("click", function() {
                ...
                test1.question2(); //executes a function that shows next question
            });
        },
        ...
        question2: function() {
            ...
            alternative1.addEventListener("click", function () {
                ...
                alternative1.classList.toggle("green")
                alternative2.classList.toggle("red")
                alternative3.classList.toggle("red")
                if (counterChoice < 1) {
                    test1score += 5;
                    resultDiv.appendChild(result1);
                    content.appendChild(nextButton);
        ...
        question4: function() {
            ...
            alternative1.addEventListener("click", function () {
                result1.innerHTML = "Fel :(";
                alternative1.classList.toggle("red")
                alternative2.classList.toggle("green")
                alternative3.classList.toggle("red")
                if (counterChoice < 1) {
                    resultDiv.appendChild(result1);
                    content.appendChild(nextButton);
